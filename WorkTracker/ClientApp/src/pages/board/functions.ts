...
export function createNewTask(taskCount: number, storyId?: number | null) {
  return {
    taskId: taskCount + 1,
    storyId: storyId ?? 0,
    description: "",
...
export function handleTaskChange(tasks: Task[], taskId: number, value: string) {
...
export async function removeTaskById(tasks: Task[], taskId: number) {
...
export function reorder(list: Story[], startIndex: number, endIndex: number) {
...
export function createPayload(stateId: string | number, storyList: Story[]) {
